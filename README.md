...
**Android 10+** · Kotlin + Compose · 805 pruebas · sin red, sin cuentas, sin analítica
...
./gradlew testDebugUnitTest    # 805 pruebas
./gradlew lintDebug
```
...
La lógica delicada vive en objetos puros para poder probarla sin dispositivo: **805 pruebas**
