...
**Android 10+** · Kotlin + Compose · 936 pruebas · sin red, sin cuentas, sin analítica
...
./gradlew testDebugUnitTest    # 936 pruebas
./gradlew lintDebug
```
...
La lógica delicada vive en objetos puros para poder probarla sin dispositivo: **936 pruebas**
