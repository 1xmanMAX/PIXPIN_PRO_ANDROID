...
**Android 10+** · Kotlin + Compose · 2.214 pruebas · **sin cuentas y sin analítica**; la red solo
...
./gradlew testDebugUnitTest    # 2.214 pruebas, en la JVM
./gradlew lintDebug
```
...
La lógica delicada vive en objetos puros para poder probarla sin dispositivo: **2.214 pruebas**
