...
**Android 10+** · Kotlin + Compose · 926 pruebas · sin red, sin cuentas, sin analítica
...
./gradlew testDebugUnitTest    # 926 pruebas
./gradlew lintDebug
```
...
La lógica delicada vive en objetos puros para poder probarla sin dispositivo: **926 pruebas**
