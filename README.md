...
**Android 10+** · Kotlin + Compose · 883 pruebas · sin red, sin cuentas, sin analítica
...
./gradlew testDebugUnitTest    # 883 pruebas
./gradlew lintDebug
```
...
La lógica delicada vive en objetos puros para poder probarla sin dispositivo: **883 pruebas**
