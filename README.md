...
**Android 10+** · Kotlin + Compose · 902 pruebas · sin red, sin cuentas, sin analítica
...
./gradlew testDebugUnitTest    # 902 pruebas
./gradlew lintDebug
```
...
La lógica delicada vive en objetos puros para poder probarla sin dispositivo: **902 pruebas**
