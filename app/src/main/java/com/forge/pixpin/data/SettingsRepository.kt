...
data class Settings(
     ...
     */
    val modoNoche: ModoNoche = ModoNoche.COSMOS,
...
/** Cómo se ve la aplicación. [COSMOS], el del sistema solar, es el de fábrica desde el 17-sep-2026. */
enum class ModoNoche { SISTEMA, CLARO, OSCURO, AUTO, COSMOS }
